...
let names_Array : string[] = [
  ...
  for (let personalized of names_Array) {
    console.log(`${personalized} is a Developer`);
  }
...
const Party: string[] = [
  ...
  Party.forEach((People) => {
    console.log(`${People} You Are Inviting To Dinner at Arena Rangoli Please Join Us.`);
  });
...
const GuestList: string[] = [
  ...
  let PeopleCanNotMakeIt: string = "Nasir Khan";
  ...
  const New_Guest: string = "Shafique Ahmed";
